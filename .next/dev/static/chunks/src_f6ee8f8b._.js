...
"[project]/src/app/admin/news/edit/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditNewsPage({ params }) {
    _s();
    const { isAdmin, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAdminAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAdminAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditNewsPage.useEffect": ()=>{
            ...
            const fetchNews = {
                "EditNewsPage.useEffect.fetchNews": async ()=>{
                    try {
                        // Admin için özel fonksiyon kullan - RLS policy'yi bypass eder
                        const news = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNewsByIdAdmin"])(id);
                        if (news) {
                            setFormData({
                                title: news.title || '',
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Haber bulunamadı!', 'error');
                            router.push('/admin/news');
                        }
                    } catch (error) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Error fetching news:', error);
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Haber yüklenirken hata oluştu!', 'error');
                    } finally{
                        setLoading(false);
                    }
                }
            }["EditNewsPage.useEffect.fetchNews"];
            fetchNews();
        }
    }["EditNewsPage.useEffect"], [
        id,
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!formData.title.trim()) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Lütfen haber başlığı girin!', 'warning');
            return;
        }
        if (!formData.content.trim()) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Lütfen haber içeriği girin!', 'warning');
            return;
        }
        if (!formData.category) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Lütfen kategori seçin!', 'warning');
            return;
        }
        if (formData.excerpt && formData.excerpt.length > 150) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Özet 150 karakterden uzun olamaz!', 'warning');
            return;
        }
        setSaving(true);
        try {
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateNews"])(id, {
            ...
            if (success) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Haber başarıyla güncellendi!', 'success');
                setTimeout(()=>{
                    router.push('/admin/news');
                }, 1000);
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Haber güncellenirken hata oluştu!', 'error');
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Error updating news:', error);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Haber güncellenirken beklenmedik bir hata oluştu!', 'error');
        } finally{
            setSaving(false);
        }
    };
...
_s(EditNewsPage, "lea+67DSSJLDPSEVbzo49Kk+jb0=", false, function() {
    return [
...
_c = EditNewsPage;
var _c;
__turbopack_context__.k.register(_c, "EditNewsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f6ee8f8b._.js.map