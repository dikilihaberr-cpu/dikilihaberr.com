                ...
                "AuthProvider.useEffect.checkSession": async ()=>{
                    try {
                        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) {
                            ...
                            console.error('📋 .env.local dosyasını kontrol edin: NEXT_PUBLIC_SUPABASE_URL ve NEXT_PUBLIC_SUPABASE_ANON_KEY');
                        ...
                        if (error) {
                            ...
                            if (error.message?.includes('JWT') || error.message?.includes('token')) {
                                console.error('🔍 Token hatası - Supabase bağlantısını kontrol edin');
                            }
                        } else {
                            ...
                            if (mounted) {
                                ...
                                if (session?.user) {
                                    ...
                                    try {
                                        ...
                                        if (mounted) {
                                            console.log('🔐 Initial admin check:', session.user.email, '=', adminStatus ? '✅ ADMIN' : '❌ NOT ADMIN');
                                            setIsAdmin(adminStatus);
                                        }
                                    } catch (adminError) {
                                        console.error('❌ Admin check failed:', adminError?.message || adminError);
                        ...
                        if (event === 'SIGNED_IN') {
                            ...
                            if (mounted) {
                                ...
                                if (session?.user) {
                                    const adminStatus = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAdmin"])();
                                    if (mounted) {
                                        console.log('Auth change - admin check:', session.user.email, '=', adminStatus ? 'ADMIN ✅' : 'NOT ADMIN ❌');
                                        setIsAdmin(adminStatus);
                                    }
                                }
                            }
...
_s(Navbar, "JPCwLY+5qyD7f4o5MN5ENlVagaY=", false, function() {
    return [
...
//# sourceMappingURL=src_2ed32110._.js.map