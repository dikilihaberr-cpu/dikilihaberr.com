            ...
            const checkSession = {
                "AuthProvider.useEffect.checkSession": async ()=>{
                    try {
                            ...
                            if (mounted) {
                                ...
                                if (session?.user) {
                                    ...
                                    try {
                                        ...
                                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('❌ Admin check failed:', adminError?.message || adminError);
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('❌ Session check error:', error?.message || error);
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('🔍 Hata detayları:', error);
                    } finally{
                        if (mounted) setLoading(false);
                    }
                }
...
_s1(AuthProvider, "FmkfeXwdguvSQXNDgNQaqOZliLo=");
_c = AuthProvider;
var _c;
...
//# sourceMappingURL=src_42a984ca._.js.map