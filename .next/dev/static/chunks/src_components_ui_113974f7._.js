...
function CommentsSection({ newsId }) {
    ...
    const handleSubmitComment = async (e)=>{
        ...
        setError(null);
        try {
            const comment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addComment"])(newsId, newComment.trim());
            if (comment) {
                setComments((prev)=>[
                        comment,
                        ...prev
...
//# sourceMappingURL=src_components_ui_113974f7._.js.map