    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            const checkAdminAccess = {
                "AdminDashboard.useEffect.checkAdminAccess": async ()=>{
                    try {
                        ...
                        const { data: adminUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('admins').select('*').eq('user_id', session.user.id).single();
                        if (!adminUser) {
                            router.push('/');
                            return;
                        }
            ...
            }["AdminDashboard.useEffect.checkAdminAccess"];
            checkAdminAccess();
        }
    }["AdminDashboard.useEffect"], [
        router
...
_s(AdminDashboard, "XPUDBycxU526tyBMAcDLLXOuBUA=", false, function() {
    return [
...
//# sourceMappingURL=_d2c6a11d._.js.map