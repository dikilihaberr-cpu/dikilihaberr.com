                            ...
                            if (mounted && !abortController.signal.aborted) {
                                ...
                                if (session?.user) {
                                    try {
                                        ...
                                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('Admin check error:', adminError?.message || adminError);
                                        if (mounted && !abortController.signal.aborted) setIsAdmin(false);
                                    }
                                }
                            }
...
//# sourceMappingURL=src_f5925850._.js.map